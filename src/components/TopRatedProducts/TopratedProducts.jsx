                ...
                >
                    {
                        products?.map((product) => {
                            const { _id, img, title, categoryName, price, productStatus, size, discount } = product;
                            return (
                                <SwiperSlide key={_id}>
                                    <div className="">
                                        <div className="m-3 border border-gray-200 rounded prod_card ">
                                            <div className="relative overflow-hidden">
                                                <img src={img} className='w-[400px] md:w-[400px] h-[250px] lg:w-[300px] object-cover md:h-[210px]' />
                                                {/* button group */}
                                            ...
                                            <div className="p-3 overflow-hidden">
                                                ...
                                                {/* product price */}
                                                <span className="text-lg font-semibold text-textPrimary my-2 pb-2">${price}</span>
