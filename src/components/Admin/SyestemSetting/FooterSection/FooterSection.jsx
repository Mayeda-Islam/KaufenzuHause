...
const FooterSection = () => {
    ...
    const handleOPenDescription = () => {
        openDescription === true ? setOpenDescription(false) : setOpenDescription(true)
    }
    return (
                ...
                <div className="m-4">
                    ...
                    <div
                        ...
                        <button
                            ...
                            className='py-2 px-5  text-sm font-medium text-white bg-primary rounded-sm border-[3px] border-primary hover:bg-secondary hover:border-secondary '>Edit Description</button>
                    </div>
                    <Modal
                        keepMounted
                                    ...
                                    <div className=" w-full ">
                                        <div className="border-0 rounded-lg shadow-lg  flex flex-col w-full bg-white outline-none focus:outline-none">
                                            ...
                                            <div className=" p-6 flex-auto w-full border-2 border-gray-200 rounded mt-[1rem]">
                                                ...
                                                >
                                                    <label className="block mb-3 text-sm font-medium text-gray-900 ">Footer Description</label>
                                                    <textarea
                                                        rows="4"
                ...
                <div className="m-4">
                    ...
                    <div className="text-left my-6">
                        <button
                            ...
                            className='py-2 px-5  text-sm font-medium text-white bg-primary rounded-sm border-[3px] border-primary hover:bg-secondary hover:border-secondary '>Edit Information</button>
                    </div>
                    <Modal
                        keepMounted
                        open={openInfo}
                                            ...
                                            <div className='  p-6 flex-auto w-full border-2 border-gray-200 rounded ='>
                                                ...
                                                >
                                                    ...
                                                    <div className="mb-3">
                                                        ...
                                                        <input
                                                            type="text"
                                                            className={`bg-gray-50 text-gray-900 text-sm rounded-lg focus:outline-none  block w-full p-2.5 border border-gray-300`} placeholder="Your name"
                                                            {...register("address", {
                                                    ...
                                                    <div className="mb-3">
                                                        ...
                                                        <input
                                                            type="text"
                                                            className={`bg-gray-50 text-gray-900 text-sm rounded-lg focus:outline-none  block w-full p-2.5 border border-gray-300`} placeholder="Phone Number"
                                                            {...register("phone", {
