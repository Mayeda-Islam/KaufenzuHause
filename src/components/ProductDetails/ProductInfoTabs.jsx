                ...
                <TabPanel value={value} index={1}>
                    <div className="pt-5 flex flex-wrap lg:flex-nowrap">
                        <div className="w-full lg:w-6/12">
                            <h1>Replies = 5</h1>
                            <div className="m-4 flex  md:flex-row md:space-x-6 justify-between border-b border-blue-500 shadow-md px-5 py-3 rounded-md mt-3 mb-4">
                        ...
                        <div className="w-full lg:w-6/12">
                            <div className="m-4 border-0 rounded-md  flex flex-col w-full bg-white outline-none focus:outline-none">
                                <div className="flex items-start justify-between pb-5 rounded-t bg-transparent">
                                    <h3 className="text-2xl text-textColor font-semibold">
                                        Please Leave your Review here
                                    </h3>

                                </div>
                                {/*body*/}
                                <div className=" px-6 py-8 flex-auto w-full shadow-sm shadow-gray-200 border border-gray-200 rounded-md">
                                    <form action=""
                                        onSubmit={''}
                                    >
                                        {/* user full name */}
