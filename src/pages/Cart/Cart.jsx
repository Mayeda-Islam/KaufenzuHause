            ...
            <div className=" w-[95%] lg:w-[94%] mx-auto">
                <div className="flex justify-center flex-wrap">
                    <div className="w-full md:w-full lg:w-8/12">
                        <div className="m-3">
                            <h2 className="text-2xl md:text-2xl font-medium text-textColor">Shopping Cart</h2>
                            <div className=" py-6">
                                                    ...
                                                    <tr className=" border-b mb-3">
                                                        <th scope="row" className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                            <div className="flex  items-center gap-3">
                                                                ...
                                                                <img src={cart.img} className='md:w-[100px] md:h-[100px] lg:w-[90px] lg:h-[90px]' />
                                                        ...
                                                        <td className="px-6 py-4">
                                                            <h3 className="text-base font-medium text-textPrimary mb-3">{cart.title.slice(0, 20)}</h3>
                                                        </td>
                                                        <td className="px-6 py-4">
                    ...
                    <div className="w-full md:w-full lg:w-4/12">
                        <div className="m-4">
                            <h3 className="text-2xl md:text-2xl font-medium text-textColor">Cart Total</h3>
                                ...
                                <table className=' w-full text-[13px] text-left text-gray-500 dark:text-gray-400 '>
                                    <tbody>
                                        <tr className=" border-b border-gray-300 mb-5">
                                            <th scope="row" className=" px-6 py-4 font-normal text-gray-900 whitespace-nowrap dark:text-white uppercase">
                                                SubTotal
                                            </th>
                                            <td className="px-6 py-4">
                                                $521
